...
class BasePromptTemplate(ABC, BaseModel):
    """ The base Model on top of which specific query related Template functionalities are built.
    """
    ...
    def create_template(self, to_expand_to_n: int) -> PromptTemplate:
        ...
        return PromptTemplate(
            ...
            partial_variables={
                ...
                "to_expand_to_n": to_expand_to_n, # number of versions to generate to include in prompt for each execution
            },
        )
