"""
This module encapsulates all Vector Embeddings models
"""
...
class PostVectorDBModel(VectorDBDataModel):
    entry_id: str
    platform: str
    chunk_id: str
    chunk_content: str
...
class ArticleVectorDBModel(VectorDBDataModel):
...
class RepositoryVectorDBModel(VectorDBDataModel):
